...
export default function InstellingenPage() {
  ...
  return (
    <div className="space-y-3">
      ...
      <button
        onClick={handleClear}
        className="w-full flex items-center gap-3 px-4 py-4 bg-white border border-red-100/60 rounded-2xl text-sm font-medium text-red-400 shadow-sm hover:bg-red-50 active:scale-[0.98] transition-all duration-150"
      >
        <TrashIcon />
        Verwijder alle data
      </button>
